...
def pytest_addoption(parser):
    ...
    parser.addoption("--base-url", default="https://naveenautomationlabs.com/opencart/index.php?route=account/login", help="Base URL for tests")
    ...
    parser.addoption("--slowmo", default=0, type=int, help="Slow mo delay in ms")
...
def browser_context(request):
    ...
    if browser_name.lower() == "chromium":
        ...
        browser = playwright.chromium.launch(headless=not headed_flag,slow_mo=slow_mo)
